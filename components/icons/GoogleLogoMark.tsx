...
type GoogleLogoMarkProps = {
  className?: string;
  /** Default 20 to sit beside button label. */
  size?: number;
};

/** Google "G" mark — official 4-color fills on the same paths as the gray asset. */
const GOOGLE_BLUE = "#4285F4";
const GOOGLE_GREEN = "#34A853";
const GOOGLE_YELLOW = "#FBBC05";
const GOOGLE_RED = "#EA4335";

export function GoogleLogoMark({ className, size = 20 }: GoogleLogoMarkProps) {
  return (
    <svg
    ...
    >
      <g stroke='none' strokeWidth={1} fill='none' fillRule='evenodd'>
        ...
        <g transform='translate(13.65, 13.65) scale(1.43)'>
          <path
          ...
          <path
            ...
            fill={GOOGLE_RED}
          />
          <path d='M0,0 L18,0 L18,18 L0,18 L0,0 Z' fill='none' />
        </g>
      </g>
    </svg>
  );
